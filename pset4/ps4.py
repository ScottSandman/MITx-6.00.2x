...
def evaluate_models_on_training(x, y, models):
    ...
    y_vals = np.array(y)
    for i in models:        
        pylab.plot(x_vals, y_vals, 'bo', label = "Data")
        a, b = models[0][0], models[0][1]
        estY = a*x_vals + b
        pylab.plot(x_vals, estY, 'r', label = "R2 = " + str(round(r_squared(y, estY), 3)))
        pylab.title('Temperature by Year')
